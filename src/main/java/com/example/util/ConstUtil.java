...
public class ConstUtil {
    ...
    public static final TypeToken<List<PotionsObtained>> POTIONS_OBTAINED_TYPE_TOKEN = new TypeToken<>(){};
    public static final TypeToken<List<ItemsPurchased>> ITEMS_PURCHASED_TYPE_TOKEN = new TypeToken<>(){};
    public static final TypeToken<ArrayList<ItemsPurchased>> ITEMS_PURCHASED_FLOORS_TYPE_TOKEN = new TypeToken<>(){};
