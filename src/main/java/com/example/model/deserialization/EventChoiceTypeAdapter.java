...
public class EventChoiceTypeAdapter extends TypeAdapter<List<EventChoice>> {
    @Override
            ...
            while (in.hasNext()) {
                switch (in.nextName()) {
                    ...
                    case "cards_removed": {
                        ...
                        in.endArray();
                        eventChoice.setEventCardsRemovedList(eventCardsRemoveds);
                        break;
                    }
                    case "cards_transformed": {
                        ...
                        in.endArray();
                        eventChoice.setEventCardsTransformedList(eventCardsTransformeds);
                        break;
                    }
                    case "cards_obtained": {
                        ...
                        in.endArray();
                        eventChoice.setEventCardsObtainedList(eventCardsObtaineds);
                        break;
                    }
                    case "cards_upgraded": {
                        ...
                        in.endArray();
                        eventChoice.setEventCardsUpgradedList(eventCardsUpgradeds);
                        break;
                    }
                    case "relics_obtained": {
                        ...
                        in.endArray();
                        eventChoice.setEventRelicsObtainedList(eventRelicsObtaineds);
                        break;
                    }
                    case "relics_lost": {
                        ...
                        in.endArray();
                        eventChoice.setEventRelicsLostList(eventRelicsLosts);
                        break;
                    }
                    case "potions_obtained": {
                        ...
                        in.endArray();
                        eventChoice.setEventPotionsObtainedList(eventPotionsObtaineds);
                        break;
                    }
                }
            }
